...
import { login_page, route_public_page } from "@/app/routes/page_routes";
...
function CreatorHero({
  ...
  return (
    <div className={`relative  dark:bg-gray-800 overflow-hidden w-full`}>
        ...
        <div className="flex px-4 justify-between">
          <div className="flex flex-wrap xl:items-center -mx-4">
              ...
              <div className="flex flex-wrap">
                <div className="w-full md:w-auto py-1 md:py-0 md:mr-4">
                  <Link
                    ...
                    href={preference.heroLink1 ?? login_page({ subBase: siteInfo.slug! })}
                  >
                    Start Selling
                  </Link>
                </div>
                <div className="w-full md:w-auto py-1 md:py-0">
                  <Link
                    ...
                    href={preference.heroLink2 ?? route_public_page({ paths: ["signup"] })}
                  >
                    Sign Up
                  </Link>
                </div>
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max rounded-3xl">
                <Image
                  width={200}
                  height={200}
                  className="absolute z-[2] -left-14 -top-12 w-28 md:w-auto"
                  src={preference.upperImage ?? `/images/circle3-yellow.svg`}
                  alt=""
                />
                <Image
                  width={200}
                  ...
                  src={preference.lowerImage ?? `/images/dots3-blue.svg`}
                  alt=""
                  priority
                />
                <Image
                  width={500}
                  height={500}
                  className="relative rounded-3xl h-auto w-auto border"
                  src={preference.heroImage ?? `/images/header.png`}
                  alt=""
                  priority
                />
              </div>

...
import { Overlay, RaisedButton } from '@/app/widgets/widgets';
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col h-full`}>
            ...
            <CustomHeader silverImage={showHeaderImage ? silverImage : ''}>
              ...
              >
                ...
                <div className="flex flex-row justify-between mx-3 items-center space-x-3">
                  ...
                  {slug && (
                    <>
                      <CustomLink href={slug} target="_blank" className="h-6 w-6 z-30">
                        <ExternalLink />
                      </CustomLink>
                    </>
                  )}
        ...
        <div
          className={`overflow-y-auto scrollbar-hide-mobile sm:border-l sm:border-gray-300 bg-white`}
        >
          {loadedPage}
        </div>
      </div>

...
export const mode: "test" | "live" =
  process.env.NODE_ENV === "development" ? "test" : "live";
export const cbkMode: "live" | "test" =
  process.env.NODE_ENV === "development" ? "test" : "live";
...
export const availableAiModels: any[] = [
  {
    id: "mar-2025",
    title: "{name} o1",
...
export const BASE_AI_MODEL: any =
  availableAiModels.find((b) => b.id === "june-2024") ?? {};
